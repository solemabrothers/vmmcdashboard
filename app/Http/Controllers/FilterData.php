    ...
    public function index(Request $request)
    {
        ...
        $Ip_weekly_performance =DB::select("SELECT SUM(c.NumberCircumcised) As total FROM mets_vmmc.circumcision c WHERE c.ImplementingPartner='$Ip_ID' AND  DATE(c.SummaryDate) between '$startDate' AND '$endDate'");
         ...
         HAVING  positive !=0");
            ...
            $below10= new FilteredAgeGroups('< 10',$below10);
            $Between10And14= new FilteredAgeGroups('10-14',$Between10And14);
            $Between15And19= new FilteredAgeGroups('15-19',$Between15And19);
            $Between20And24= new FilteredAgeGroups('20-24',$Between20And24);
            $Between26And30= new FilteredAgeGroups('25-29',$Between26And30);
            $Between31And34= new FilteredAgeGroups('30-34',$Between31And34);
            $Between35And39= new FilteredAgeGroups('35-39',$Between35And39);
            $Between40And44= new FilteredAgeGroups('40-44',$Between40And44);
            $Above45= new FilteredAgeGroups('>45',$Above45);
