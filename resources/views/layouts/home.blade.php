...
@section('content')
    ...
    <!-- Content Header (Page header) -->
        <!-- Main content -->
        <div class="card" id="title">:TOTAL  PERFORMANCE FOR COP19 AS OF {{date("d.M.Y")}}</div>
        ...
        <div class="row">
            ...
            <div class="panel-body">
                <h4 style="padding: 0px;">IP MECHANISM  PERFORMANCE  BY AGE GROUP FOR COP19 AS  of {{date("d.M.Y")}} </h4>
